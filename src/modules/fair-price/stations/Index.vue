<template>
  <div>
    <b-row>
      <b-col cols="7">
        <b-card
            style="height: 39rem;  box-shadow: 0 4px 8px rgb(162,217,247); border-radius: 3px"
        >
          <h4 style="color: #2b675b; text-align: center; ">
            {{ $t('stations.title1') }}</h4>

          <div class="map-container">
            <svg style="height: 35rem; width: 100%" :viewBox="uzbekistan.viewBox" xmlns="http://www.w3.org/2000/svg">
              <!-- Uzbekistan xaritasi -->
              <path
                  ...
                  style="fill: #FFFFFF; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              />
              ...
              <text
                  ...
                  style="fill: #2b675b; font-size: 8px; text-anchor: middle;"
              >
                {{ region.name }}
              </text>
              <!-- Tanlangan hudud ma'lumotlarini ko'rsatish -->
              <foreignObject x="0" y="400" width="300" height="200">
                <div xmlns="http://www.w3.org/1999/xhtml" class="info-panel">
                  ...
                  <div class="mt-2">
                    ...
                    <span class="ml-1"
                          style="color: #EF7F1A; font-weight: bold; font-size: 13px">{{ $t('stations.benzin') }}</span>
                  </div>
                </div>
              </foreignObject>

              <!-- Qo'shimcha SVG -->
              <svg x="250" y="20" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
                        d="M1025.33 409.49c892.1,-585.79 2041.02,-532.84 2873.43,98.23l-1506.2 1992.59c-1367.23,-2090.82 -0.01,0 -1367.23,-2090.82z"/>

                  <path style="fill: #4D65A3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
                        d="M1078.33 490.26c-738.58,438.06 -1285.6,1484.15 -1015.26,2561l2329.48 -550.95c-1314.22,-2010.05 0,0 -1314.22,-2010.05z"/>
                  <path style="fill: #EF7F1A; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
                        d="M151.08 3030.44c274.62,1067.87 1168.4,1701.23 2133.41,1765.75 109.44,-2325 -1.37,29.12 108.06,-2295.88 -1323.68,313.06 -737.38,174.39 -2241.47,530.13z"/>
                  <path style="fill: #F49B4D; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
                        d="M2293.65 4601.42c862.79,13.1 1680.25,-413.97 2066.23,-1355.23 -1967.32,-745.88 0,0 -1967.32,-745.88 -98.91,2101.11 -0.01,0 -98.91,2101.11z"/>
                  <path style="fill: #EF7F1A; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
                        d="M2392.55 2500.31c473.69,-625.57 904.23,-1207.96 1377.92,-1833.55 531.72,382.81 1251.32,1499.59 778.26,2660.89l-2156.18 -827.34z"/>
                  <circle style="fill: #FEFEFE; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
                          cx="2392.55" cy="2500.32" r="513.08"/>
                </g>
              </svg>

              <!-- Qo'shimcha SVG -->
              <svg x="600" y="20" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG -->
              <svg x="450" y="20" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG -->
              <svg x="520" y="150" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
                        d="M1025.33 409.49c892.1,-585.79 2041.02,-532.84 2873.43,98.23l-1506.2 1992.59c-1367.23,-2090.82 -0.01,0 -1367.23,-2090.82z"/>
                  <rect x="2800" y="4200" width="200" height="100" fill="white"/>
                  <text x="2300" y="700" style="fill: #FFFFFF; font-size: 500px; text-anchor: middle;">
                    6500
                  </text>
                  <!--                  <text x="2300" y="1300" style="fill: #FFFFFF;font-size: 500px; text-anchor: middle;">-->
                  <!--                    <span style="background-color: #FFFFFF !important; color: #2b675b">Propan</span>-->
                  <!--                  </text>-->
              ...
              <svg width="300" height="200" xmlns="http://www.w3.org/2000/svg">
                <!--               Chiziq: (x1, y1) -> (x2, y2)-->
                <!--                              <line x="200" y="500" x2="150" y2="100" stroke="black" stroke-width="2" />-->

                <!--               Boshqa chiziq-->
                <!--                                              <line x1="200" y="500" x2="190" y2="190" stroke="red" stroke-width="4" />-->

                <!--               Diagonal chiziq-->
                <!--                <line x1="10" y1="10" x2="190" y2="190" :stroke="'#2b675b'" stroke-width="3"/>-->
              </svg>

              <!-- Qo'shimcha SVG -->
              <svg x="100" y="30" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG -->
              <svg x="300" y="150" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG -->
              <svg x="680" y="110" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG -->
              <svg x="100" y="250" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG -->
              <svg x="180" y="340" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG -->
              <svg x="300" y="410" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG -->
              <svg x="590" y="320" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG Andijon-->
              <svg x="680" y="370" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
              ...
              <!-- Qo'shimcha SVG Surxandaryo-->
              <svg x="570" y="415" width="40.4mm" height="40.4mm" viewBox="0 0 7500 7800"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="additional-svg" transform="translate(200, 500)">
                  <!-- Existing paths for Uzbekistan -->
                  <path style="fill: #4696D3; stroke: #2b675b; stroke-width: 2px; cursor: pointer;"
          ...
          <b-col cols="4">
            <div class="card1">
              ...
              <div class="body-content1">
                <b-row>
                  <span style="font-size: 14px; font-weight: 500; color: #2b675b">
               {{ $t('submodules.integration.price_stock.region_name') }}
                  </span>
                  <b-form-select
                      style="width: 78%; margin-left: 5px; float: right; color: #2b675b"
                      v-model="region"
                      size="sm">
                    <b-form-select-option :value="null">O'zbekiston Respublikasi</b-form-select-option>
                ...
                <b-row class="mt-1" style="justify-content: space-between;">
                  <span style="font-size: 14px; font-weight: bold; color: #EF7F1A">
                        {{ $t('stations.benzin_stations') }}
                  </span>
                  <span
                      style="border-left: 4px solid #D57726; width: 60px; background: #F49B4D; margin-right: 0; text-align: center; color: #FFFFFF; font-weight: bold; font-size: 15px">
                    12000
                  </span>
                </b-row>
              </div>
            ...
            <div class="card2">
              ...
              <div class="body-content2">
                <b-row style="justify-content: space-between;">
                  ...
                  <b-col cols="6">
                    <b-row class="mt-1" style="justify-content: space-between;">
                  <span class="ml-2" style="font-size: 13px; font-weight: bold; color: #2b675b">
                           Toshkent sh.
                  </span>
                      <span>
                        <img style="width: 13px" class="user-img" src="./files/info_red.svg" alt="">
                      </span>
                    </b-row>
                  </b-col>
                </b-row>
                ...
                <b-row style="justify-content: space-between;">
                  <b-col cols="6">
                    <b-row style="justify-content: space-between;">
                  <span style="font-size: 12px; font-weight: bold; color: #EF7F1A">
                          {{ $t('stations.benzin80') }}
                  </span>
                      <span
                          style="border-left: 4px solid #97052D; width: 50px; background: #AD3958;margin-right: 0; text-align: center; color: #FFFFFF; font-weight: bold;
            ...
            <div class="card3">
              ...
              <div class="body-content3">
                <b-row style="justify-content: space-between;">
                  ...
                  <b-col cols="6">
                    <b-row class="mt-1" style="justify-content: space-between;">
                  <span class="ml-2" style="font-size: 13px; font-weight: bold; color: #2b675b; width: 80%">
                           Toshkent sh.
                  </span>
                      <span>
                       <img style="width: 13px" class="user-img" src="./files/info_green.svg" alt="">
                      </span>
                    </b-row>
                  </b-col>
                </b-row>
      ...
      <b-col cols="5">
        <b-card
            style="height: 17rem; box-shadow: 0 4px 8px rgb(162,217,247);border-radius: 3px"
        >
          <LineCharts></LineCharts>
        </b-card>

        <b-card
            style="height: 32rem; box-shadow: 0 4px 8px rgb(162,217,247);border-radius: 3px"
        >
          <b-row style="margin-top: -15px !important;">
            <b-col cols="6">
              <b-button size="sm" class="colorBtnActive" style="cursor: default">
                {{ $t('stations.info_stations') }}
              </b-button>
            </b-col>
            <b-col cols="6">
          ...
          <table class="table text-center mt-1" style="border-collapse: separate;">
            ...
            <tr>
              ...
              <th width="25%">{{ $t('stations.name') }}</th>
              <th width="10%">{{ $t('stations.cost') }}</th>
              <th width="14%">{{ $t('stations.date') }}</th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
              <td>1</td>
              <td>Shaxobcha</td>
              <td style="font-size: 9px; text-align: left">Toshkent sh., Chilonzor tumani,
                Oqtepa 5
              </td>
              <td>Propan</td>
              <td>6600</td>
            ...
            <b-pagination
                class="mt-1"
                size="sm"
                style="background: #2b675b; border: 1px solid #2b675b"
                v-model="currentPage"
                :total-rows="10"
                :per-page="13"
            ></b-pagination>
...
export default {
  ...
  methods: {
    ...
    //   alert(`Siz ${location.name} ni tanladingiz!`);
    // },
    async getRegions() {
